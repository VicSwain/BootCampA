...
var highlight4 = document.querySelectorAll("h4");
console.log(highlight4);

// how to iterate through an array
for (var i = 0; i < highlight4.length; i++) {
highlight4[i].setAttribute("style", "font-size: 30px; color: blue; padding-left: 10px; margin: 0; bolder");
}
