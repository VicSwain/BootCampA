...
// using let here will make this work. const is not working because item is being redefined
// const item = {
//   id: 23,
...
// to make this work change const in line 54 to let
...
njs.forEach((nt) => ninjaTurtles.push(nt));
console.log(njs);
njs.push('Huracan');
console.log(njs); // this is how you would add to the array
