...
// function to take in user review and post it and console.log successful post or error depending 
const postReview = (review) =>
  ...
  fetch('/api/reviews', {
    ...
    // JSON object being turned into a string 
    ...
    // catch if there is an error and log to console
    .catch((error) => {
