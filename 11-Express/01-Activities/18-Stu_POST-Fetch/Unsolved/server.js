...
app.post('/api/reviews', (req, res) => {
  ...
  // ensuring the user has put in all values needed to create the new object for posting
  if (product && review && username) {
    ...
    // response status code of 201 and show our reponse in json format
    res.status(201).json(response);
  } else {
    // TODO: Add a comment describing the purpose of the else statement in this POST request.
    // sever side stotus code with 
